...
static int l2cap_build_amp_reconf_req(struct sock *sk, void *data, size_t size)
{
	struct l2cap_pinfo *pi = l2cap_pi(sk);
	struct l2cap_conf_req *req = data;
	struct l2cap_conf_rfc rfc = { .mode = pi->mode };
...
static int l2cap_parse_amp_move_reconf_req(struct sock *sk, void *data, size_t size)
{
	struct l2cap_pinfo *pi = l2cap_pi(sk);
	struct l2cap_conf_rsp *rsp = data;
	void *ptr = rsp->data;
